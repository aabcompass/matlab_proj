...
clear all; 
level=1; % задать уровень триггера. / Data type {raw, 1st integrated, 2nd integrated}
frame_step=1;
mode_2d = 1;
mode_lightcurve = 0;
fix_color_map = 0;
